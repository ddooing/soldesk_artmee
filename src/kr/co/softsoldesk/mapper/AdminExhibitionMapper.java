...
public interface AdminExhibitionMapper {
	...
	// ===============================================전시회 관리========================================
		...
		@Select("SELECT \r\n"
				...
				+ "    g.gallery_name AS apply_name, \r\n"
				+ "    g.gallery_email AS apply_email, \r\n"
				+ "    g.gallery_telephone AS apply_telephone,\r\n"
		...
		@Select("SELECT e.exhibition_enroll_id, e.title, e.author, e.price, "
				+ "To_char(e.exhibition_start, 'yyyy-mm-dd') as exhibition_start , "
				+ "To_char(e.exhibition_end, 'yyyy-mm-dd') as exhibition_end, "
				+ "e.enroll_state, u.name as apply_name\r\n"
				+ "FROM exhibition_enroll e "
				+ " JOIN gallery g ON e.gallery_id = g.gallery_id  "
				+ " JOIN user_table u ON g.gallery_user_id = u.user_id "
		...
		@Select("SELECT e.exhibition_enroll_id,e.title,e.author,"
				...
				+ "    TO_CHAR(e.exhibition_end, 'yyyy-mm-dd') as exhibition_end, \r\n"
				+ "    g.open, g.holiday,g.address,g.site, e.place,"
				+ "    e.enroll_state,e.main_poster_file_id, e.detail_poster_file_id,"
				+ "	   e.gallery_id,g.gallery_name AS apply_name, "
				+ "	   g.gallery_email AS apply_email, \r\n"
				+ "    g.gallery_telephone AS apply_telephone,\r\n"
		...
		@Insert("INSERT INTO exhibition "
				+ "(exhibition_id, title, regdate, author, price, exhibition_start, exhibition_end, place,state, gallery_id,"
		...
		@Select("SELECT \r\n"
				...
				+ "    exhibition_enroll e\r\n"
				+ "JOIN \r\n"
				+ "    gallery g ON e.gallery_id = g.gallery_id\r\n"
				+ "JOIN \r\n"
				+ "    user_table u ON g.gallery_user_id = u.user_id"
				+ "WHERE \r\n"
